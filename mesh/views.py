...
class LTEDashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        with connection.cursor() as cursor:
            cursor.execute("select id, data_co, data_o2, data_ch4, data_temp, data_humid, volt, created from catm1_sensor_data where device_name = 'sensor001' order by created asc limit 1000;")
