...
class MultipleDashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        df_xenon1 = df_xenon1[df_xenon1['datetime']>'2019-04-25 0:30']
        df_xenon2 = df_xenon2[df_xenon2['datetime']>'2019-04-25 0:30']
        df_xenon3 = df_xenon3[df_xenon3['datetime']>'2019-04-25 0:30']
        df_xenon4 = df_xenon4[df_xenon4['datetime']>'2019-04-25 0:30']
